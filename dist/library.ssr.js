        ...
        (_vm.error
          ? '<ul class="errors">' +
            _vm._ssrList(_vm.normalizedErrors, function(err) {
              return "<li>" + _vm._ssrEscape(_vm._s(err)) + "</li>"
            }) +
            "</ul>"
          : "<!---->")
    )
...
__vue_render__._withStripped = true;
  ...
  /* module identifier */
  const __vue_module_identifier__ = "data-v-1c8287a3";
  /* functional template */
